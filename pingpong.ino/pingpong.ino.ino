...
void loop() {
  ...
  if (lbutton.pressed() && mbutton.read() != Button::PRESSED) {
    leftScore ++;
    updateScore();
  }

  else if (rbutton.pressed() && mbutton.read() != Button::PRESSED) {
    rightScore++;
    updateScore();
...
//  }
  ...
  //else if (mbutton.read() == Button::PRESSED && lbutton.pressed()){
  //    leftScore--;
  //    updateScore();
  ...
  //
  //
  //else if (mbutton.read() == Button::PRESSED && rbutton.pressed()){
  //    rightScore--;
  //    updateScore();
  //    //Serial.println(rightScore);
  //  }

  while (mbutton.read() == Button::PRESSED) {
    if (lbutton.pressed() {
    leftScore--;
    updateScore();
      //Serial.println(leftScore);
    ...
    else if (lbutton.read() == Button::PRESSED && rbutton.read() == Button::PRESSED) {
    delay(1500);
      leftScore = 0;
      rightScore = 0;
      clearScore();
